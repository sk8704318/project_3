...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/welcomepage.jpg');
	background-size: cover;
						...
						<div class="card-body">
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input  type="text" class="form-control input-group-addon hover shadow"
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="password" id="myInput"
										class="form-control input-group-addon shadow" name="password"
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-xl " style="font-size: 17px"
									value="<%=LoginCtl.OP_SIGN_IN%>"> <input type="submit"
									name="operation" class="btn btn-primary btn-md"
